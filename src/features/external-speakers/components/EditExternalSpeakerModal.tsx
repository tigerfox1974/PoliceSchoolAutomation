...
import { useEditExternalSpeaker } from '../hooks/useEditExternalSpeaker'
import { ExternalSpeaker } from '../types'
import { Icon } from '@iconify/react'

interface EditExternalSpeakerModalProps {
  isOpen: boolean
  onClose: () => void
...
export default function EditExternalSpeakerModal({
  isOpen,
  onClose,
  onSuccess,
  onError,
  externalSpeaker,
}: EditExternalSpeakerModalProps) {
  const {
    firstName,
    lastName,
    title,
    ...
    removeExpertise,
    handleSubmit,
  } = useEditExternalSpeaker({ isOpen, externalSpeaker, onSuccess, onError })
  ...
  if (!externalSpeaker) return null

  return (
    <Modal isOpen={isOpen} onClose={onClose} title="✏️ Dış Konuşmacı Düzenle" size="lg">
