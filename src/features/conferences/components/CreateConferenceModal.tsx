...
import { CONFERENCE_STATUS_CONFIG, SPECIAL_ROOM_TYPES, ConferenceStatus } from '../types'
...
export default function CreateConferenceModal({
  ...
  const {
    ...
    handleSubmit,
    resetForm,
  } = useCreateConference({ isOpen, onSuccess, onError })
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="🎤 Yeni Konferans Oluştur" size="lg">
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
            placeholder="Örn: Yangın ve Tabii Afetler"
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={2}
            placeholder="Konferansın ana konusu..."
            className="w-full px-4 py-2 border rounded focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600"
          />
        </div>
        ...
        <div className="flex gap-3 pt-4">
          ...
          >
            {isSubmitting ? 'Oluşturuluyor...' : 'Konferans Oluştur'}
          </button>
        </div>
      </form>
    </Modal>
