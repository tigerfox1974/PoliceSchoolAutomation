...
-- Eski k?s?t/indeks isimleri schedule_entries olarak kald?; yeni isimler ve alanlar ekleniyor
...
-- Eski indeks/k?s?t isimlerini yeni isimlere ta?? (varsa)
DO $$ BEGIN
...
-- G?nl?k ders indeksleri: mevcutsa d???r, sonra olu?tur
